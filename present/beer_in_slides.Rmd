...
```{r plot_distributions, echo=FALSE, eval=TRUE}
...
```{r clustered_beer, eval=TRUE, echo=FALSE}
clustered_beer_capped <- clustered_beer %>% dobtools::cap_df() %>% beer_caps()
