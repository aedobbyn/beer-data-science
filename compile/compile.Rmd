...
Finally, a minor note: a few ancillary functions here make use of a package of helper functions I've developed. This can be downloaded with `library("devtools"); install_github('aedobbyn/dobtools')`. All of these functions here should be preceded with `dobtools::` but you can of course attach the package with `library(dobtools)` if you like.
