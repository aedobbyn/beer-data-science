...
run_neural_net <- function(df, outcome, predictor_vars) {
  ...
  # Make outcome a factor and drop its unused levels
  df$outcome <- factor(df$outcome)
  df$outcome <- droplevels(df$outcome)
  
  # Select only outcome and the predictor variables we set as a function param
...
### Updated neural net with ingredients -- xgboost?
